  ...
  const solutioncard = [
    {
      ...
      cardIcon: "/Images/carpoolingpage/icons/Component5.webp",
    },

    {
      ...
      cardIcon: "/Images/carpoolingpage/icons/Component4.webp",
    },

    {
      ...
      cardIcon: "/Images/carpoolingpage/icons/Component3.webp",
    },

    {
      ...
      cardIcon: "/Images/carpoolingpage/icons/Component2.webp",
    },
  ];
  ...
  return (
    <div className={styles.carpoolSolutions}>
      <div className={styles.carpoolSolutionIntro}>
        <h1>
          Rideshare & Carpoooling App Development Solutions We Provide
        </h1>
