      ...
      <div className={styles.nextholidayrighttbox}>
        ...
        <div className={styles.nextholidayrightinsideflexbox}>
          ...
          <div className={styles.nextholidaywrapbox1}>
            <h5>Technologies</h5>
            <p>
              <strong>Frontend:</strong> Javascript, Jquery
            </p>
            <p>
              <strong>Backend:</strong> Javascript, Node.js
            </p>
            <p>
              <strong>Web Server:</strong> Cloudflare, Node.js
            </p>

            <p>
              <strong>database:</strong> Webflow
            </p>
          </div>
          <div className={styles.nextholidaywrapbox1}>
            <h5>Available on</h5>
