  ...
  return (
    <div className={styles.portfoliobannermainboxes}>
      <div className={styles.portfoliobannerheadingtxt}>
        ...
        <p>We aim at delivering rich digital experience and building meaningful relationships with our clients through outstanding designs,business centered web solutions and best customer support.</p>
