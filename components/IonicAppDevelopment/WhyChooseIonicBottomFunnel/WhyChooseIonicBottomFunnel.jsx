...
import styles from "./WhyChooseIonicBottomFunnel.module.css";
...
export const WhyChooseIonicBottomFunnel = () => {
    ...
    return (
        <>
            <div className={styles.ionicBottomFunnelMainContainer}>
                <div className={styles.ionicBottomFunnelHeadingContainer}>
                ...
                <div className={styles.ionicBottomFunnelContainer}>
                    <div className={styles.ionicBottomFunnelBox}>
                        <div className={styles.ionicBottomFunnelDetails}>
                            <div className={styles.ionicBottomFunnelDetailsImage}>
                                <Image
                                    src={"/Images/IonicAppDevelopment/icons/image.webp"}
                                    alt={"image"}
                                    width={"0"}
                                    height={"0"}
                                    sizes={"100vw"}
                        ...
                        <div className={styles.ionicBottomFunnelDetails}>
                          <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-1.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                        ...
                        <div className={styles.ionicBottomFunnelDetails}>
                         <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-2.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                    ...
                    <div className={styles.ionicBottomFunnelBox}>
                        <div className={styles.ionicBottomFunnelDetails}>
                         <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-3.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                        ...
                        <div className={styles.ionicBottomFunnelDetails}>
                          <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-4.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                        ...
                        <div className={styles.ionicBottomFunnelDetails}>
                          <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-5.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                    ...
                    <div className={styles.ionicBottomFunnelBox}>
                        <div className={styles.ionicBottomFunnelDetails}>
                          <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-6.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                        ...
                        <div className={styles.ionicBottomFunnelDetails}>
                          <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-7.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
                        ...
                        <div className={styles.ionicBottomFunnelDetails}>
                          <div className={styles.ionicBottomFunnelDetailsImage}>
                            <Image
                                src={"/Images/IonicAppDevelopment/icons/image-8.webp"}
                                alt={"image"}
                                width={"0"}
                                height={"0"}
                                sizes={"100vw"}
