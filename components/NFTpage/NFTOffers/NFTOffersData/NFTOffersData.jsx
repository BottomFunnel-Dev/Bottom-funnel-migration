...
export const NFTOffersData = ({ current }) => {
  const cardData = {
    marketplace: {
      ...
      image: "/Images/NFTDevPhotos/NFTVector/marketplace.webp",
    },
    polygram: {
      ...
      image: "/Images/NFTDevPhotos/NFTVector/exchange.webp",
    },
    tech: {
      ...
      image: "/Images/NFTDevPhotos/NFTVector/tech.webp",
    },
    digital: {
      ...
      image: "/Images/NFTDevPhotos/NFTVector/digital.webp",
    },
    wallet: {
      ...
      image: "/Images/NFTDevPhotos/NFTVector/wallet.webp",
    },
    cloths: {
      ...
      image: "/Images/NFTDevPhotos/NFTVector/fashion.webp",
    },
  };
  ...
  return (
    <div className={styles.NFTOffersDataContainer}>
      ...
      <div className={styles.NFTOffersDataImage}>
        <Image
