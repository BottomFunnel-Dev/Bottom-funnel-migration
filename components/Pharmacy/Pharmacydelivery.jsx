        ...
        <div className={styles.szdeliveryservicediv}>
          <div className={styles.szdeliverytop}>
            <div className={styles.szdeliverysolution}>
              ...
              <p>
                Track your drivers in real-time, analyze their performance, and improve your business processes to streamline
                deliveries using a robust admin panel.
              </p>
            </div>
            ...
            <div className={styles.szdeliverysolution}>
              ...
              <p>
                Less time spent in the ordering process means better user experience. Let your app users pay easily using multiple payment options
                so as to improve their overall app experience.
              </p>
            </div>
            ...
            <div className={styles.szdeliverysolution}>
              ...
              <p>
                Use the app's in-built advanced analytics to see and analyze how your business is performing. Identify problems and make informed
          ...
          <div className={styles.szdeliverybottom}>
            <div className={styles.szdeliverysolution}>
              ...
              <p>
                Avoid messy ordering processes and long queues with our Pharmacy Delivery service app. Manage everything while sitting
                at your home with a robust Admin Panel.
              </p>
            </div>
            ...
            <div className={styles.szdeliverysolution}>
              ...
              <p>
                Make effective strategies by using features like Push Notifications and provide real-time updates to your customers
            ...
            <div className={styles.szdeliverysolution}>
              ...
              <p>
                Provide your customer loyalty bonuses, introduce referrals and do a lot more to promote your business using all-in-one
                robust admin panel.
              </p>
            </div>
          </div>
