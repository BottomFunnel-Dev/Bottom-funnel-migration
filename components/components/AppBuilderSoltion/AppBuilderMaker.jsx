...
export default function AppBuilderMaker() {
  return (
        ...
        <div className={styles.appbuildermakerspecialtypeflexboxtypeA}>
          <div className={styles.appbuildermakerspecialtypeflexboxtypeAfortextA} >
            ...
            <p>
              ...
              blocks they want in their software.Whether you are building an app
              for a salon,a website for a resturent,or an eCommerce chatbot,you
              only need to drag and drop a relevant feature block.That's it!
            </p>
          </div>
        ...
        <div className={styles.appbuildermakerspecialtypeflexboxtypeB}>
          ...
          >
            ...
            <p>
              ...
              increase the power of their software manifold with just a couple
              of clicks.
            </p>
          </div>
        </div>
        ...
        <div className={styles.appbuildermakerspecialtypeflexboxtypeA}>
          <div className={styles.appbuildermakerspecialtypeflexboxtypeAfortextA}>
            ...
            <p>
              ...
              high-tech gadgets.Furthermore,the apps or websites built on Appy
              Poe's no-code platform run on all core platforms and devices.
            </p>
          </div>
        ...
        <div className={styles.appbuildermakerspecialtypeflexboxtypeB}>
          ...
          <div className={styles.appbuildermakerspecialtypeflexboxtypeAfortextB} >
            ...
            <p>
              ...
              templates and easy-to-navigate UI, designing your unique app will
              be a breeze.No prior code knowledge is needed!
            </p>
          </div>
        </div>
        ...
        <div className={styles.appbuildermakerspecialtypeflexboxtypeA}>
          <div className={styles.appbuildermakerspecialtypeflexboxtypeAfortextA} >
            ...
            <p>
              ...
              applications. These feature blocks have some common
              functionalities that can be used and reused to develop more
        ...
        <div className={styles.appbuildermakerspecialtypeflexboxtypeB}>
          ...
          <div className={styles.appbuildermakerspecialtypeflexboxtypeAfortextB} >
            ...
            <p>
              ...
              platform can handle an increase in customers.traffic,growth in
              business, or any other changes in business strategy and evolution.
            </p>
          </div>
        </div>
      </div>
