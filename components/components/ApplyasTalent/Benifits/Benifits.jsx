...
export const Benifits = () => {
  ...
  return (
    ...
    <h1>Benifits at <span>Bottom Funnel</span> Talent Solution</h1>
    <div className={styles.applytalentbenifitsflexbox}>{hiretalentbenifitsdata.map((ele)=>{
        return (
            <div>
                <div><h4>{ele.htxt}</h4>
                <p>{ele.stxt}</p>
                </div>
           <div className={styles.hitretalentbenifitsicon}><img src={ele.icon} alt='images' /></div>
