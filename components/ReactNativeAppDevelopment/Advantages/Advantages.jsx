         ...
         <div className={styles.reactnativePageCardsInnermaindiv5}>
            <div className={styles.nativereactheading}>
               ...
               <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Hic laudantium error quaerat iste.
                  ...
                  consectetur
                  laboriosam, earum aliquid esse voluptatum maxime deleniti iste veniam.
               </p>
            </div>
               ...
               <div className={styles.nativeinnermaindiv4BoxdivFirststColum} >
                  <div className={styles.reactnativeinnermaindiv4Row}>
                     ...
                     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit in eaque quos reiciendis obcaecati
                        ...
                        Expedita necessitatibus veritatis fuga optio?
                     </p>
                  </div>
                  <div className={styles.reactnativeinnermaindiv4Row}>
                     <div className={styles.rndivbox}>
                     ...
                     <h4>Watch Your App Idea Growing </h4>
                     <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit in eaque quos reiciendis obcaecati
                        modi culpa atque, quis neque deserunt nobis dolorum aperiam enim numquam.
                        Expedita necessitatibus veritatis fuga optio?
                     </p>
                  </div>
               ...
               <div className={styles.rnativeinnermaindiv41stdivbox}>
                  <div className={styles.rn1stdivbox}>
                     ...
                     <div><h3>Rigorous Requirement Analysis</h3>
                        <p>
                           Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus laboriosam cupiditate
                        </p>
                     </div>
                  </div>
                  <div className={styles.rn1stdivbox}>
