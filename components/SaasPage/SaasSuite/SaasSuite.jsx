...
export const SaasSuite = () => {
  const cardsData = [
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/consulting.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/saas-dev.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/optimization.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/design.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/architecture.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/migration.png",
  ...
  return (
    <div className={styles.SaasSuiteMain}>
      ...
      <div className={styles.SaasSuiteImages}>
        <img src="https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/expertise.png" alt="Side image" />
        <br />
        <div className={styles.SaasSuiteFunnelImage}>
          <img src="https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/funnel.png" alt="Big funnel" />
        </div>
      </div>
    </div>
  );
