...
export const SaasValuable = () => {
  const cardsData = [
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/description.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/process.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/coding.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/backend.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/perfect.png",
    ...
    {
      icon: "https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/maintain.png",
  ...
  return (
    <div className={styles.SaasValuableMain}>
      <div className={styles.SaasValuableImages}>
        <img src="https://bottom-funnel-images.sfo3.cdn.digitaloceanspaces.com/Images/saasPhotos/valuable.png" alt="Side image" />
        <br />
