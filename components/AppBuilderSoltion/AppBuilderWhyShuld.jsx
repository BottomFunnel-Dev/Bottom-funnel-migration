...
<div className={styles.appbuildersomeheadertxtboxwhyshould}><h1>Why Should You Choose a No-code App Development Platform like Bottom Funnel ?</h1>
<div className={styles.whyshouldappbuildersolmapperbox}>{whyshoulddata.map((e)=>{
  return (
    <div className={styles.appbuilderwhydataindi}>
    <div className={styles.appbuilderwhydataindiforhtxt}><h4>{e.htxt}</h4></div>
    <div className={styles.appbuilderwhydataindiforstxt}><p>{e.stxt}</p></div>
