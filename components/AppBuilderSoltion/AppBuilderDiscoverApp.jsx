...
export default function AppBuilderDiscoverApp() {
  ...
  return (
    <div className={styles.appbuilderdiscoverappmainboxes}>
      ...
      <div className={styles.appbuilderdiscoverrightbox}>
        ...
        <div className={styles.appbuildermappingdatasome}>
          {appbilderdiscoverdata.map((e) => {
            return (
        ...
        <div className={styles.lowerbuttonandsomeiconsappbuilderdiscover}>
          <div>
            <button className={styles.appbuilderdiscoversomeimageandbutton}>
              Take a look!
            </button>
          </div>
        </div>
