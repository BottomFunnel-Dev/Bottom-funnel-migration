  ...
  return (
    <div className={styles.mobilegamedevelopmentmainbox}>
      ...
      <div className={styles.mobiledevelopmentflexboxrightgamedevelopment}>
        ...
        <p>
          Mobile game development is a growing field that is full of
          opportunity. With the ubiquity of smartphones and tablets, there's
          never been a better time to create games that can be enjoyed
          on-the-go. And with so many different mobile platforms to choose from,
