  ...
  return (
    <div className={styles.Web3Developmentmainbox}>
      <div className={styles.web3developmentleftboxing}>
        ...
        <p>
          Web 3.0 is the future of gaming and it's already starting to change
          the way we think about games. Web 3.0 is a term that refers to the
          emergence of new protocols, systems, and applications that use
          blockchain technology to connect users with each other and between
          devices in a more secure, transparent, and trustless manner.
        </p>
