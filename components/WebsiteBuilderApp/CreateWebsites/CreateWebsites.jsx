    ...
    <div className={styles.createWebsiteParentDiv}>
      <div className={styles.createWebsiteImageMainDiv}>
        <div className={styles.createWebsiteImageDivBackImage}>
          <Image
            src={"/Images/WebsiteBuilderApp/RightSideBackgroundImage.webp"}
            alt={"image"}
            width={"0"}
            height={"0"}
            sizes={"100vw"}
          ...
          <div className={styles.createWebsiteImageDivTopImage}>
            <Image
              src={"/Images/WebsiteBuilderApp/CreateWebsiteFitnessImage.webp"}
              alt={"image"}
              width={"0"}
              height={"0"}
              sizes={"100vw"}
      ...
      <div className={styles.createWebsiteContentMainDiv}>
        ...
        <p>
          Quickly & easily publish your first webpages in a matter of minutes.
          Start with a conversion-optimized, mobile-responsive tempplate. Then
          customizeit inside the Drag & Drop Builder, and launch a professional-
        ...
        <div className={styles.createWebsiteOptionsDiv}>
          <div className={styles.createWebsiteOptionInnerDiv1}>
            <button className={styles.createWebsiteFitnessButton}>
              {" "}
              Fitness{" "}
            </button>
            <button className={styles.createWebsiteChatAppButton}>
              {" "}
              Chat app{" "}
            </button>
          </div>
          ...
          <div className={styles.createWebsiteOptionInnerDiv2}>
            <button className={styles.createWebsiteFoodAppButton}>
              {" "}
              Food App{" "}
            </button>
            <button className={styles.createWebsiteEcommerceButton}>
              {" "}
              E-commerce{" "}
            </button>
            <button className={styles.createWebsiteMoreButton}>
              {" "}
              And More{" "}
            </button>
          </div>
