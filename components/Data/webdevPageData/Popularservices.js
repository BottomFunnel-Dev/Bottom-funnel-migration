export const mernservices = {
  ...
  services: [
    ...
    },
    {
      ...
      stackimg: "Images/mern/api1.webp",
    },
    {
      ...
      stackimg: "Images/mern/object.webp",
    },
    {
      ...
      stackimg: "Images/mern/ecom.webp",
    },
  ],
};
...
export const webDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/webdevmain/Cms.webp",
      alt: "Images/webdevmain/Cms.webp",
    ...
    {
      icon: "Images/webdevmain/Ecommerce.webp",
      alt: "Images/webdevmain/Cms.webp",
    ...
    {
      icon: "Images/webdevmain/Python.webp",
      alt: "Images/webdevmain/Cms.webp",
    ...
    {
      icon: "Images/webdevmain/wordpress.webp",
      alt: "Images/webdevmain/Cms.webp",
    ...
    {
      icon: "Images/webdevmain/Stack.webp",
      alt: "Images/webdevmain/Cms.webp",
    ...
    {
      icon: "Images/webdevmain/Php.webp",
      alt: "Images/webdevmain/Cms.webp",
...
export const javawebDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/javapage/mobiledev.webp",
      alt: "mobiledev.png",
    ...
    {
      icon: "Images/javapage/Desktop.webp",
      alt: "desktop",
    ...
    {
      icon: "Images/javapage/appdev.webp",
      alt: "appdev.png",
    ...
    {
      icon: "Images/javapage/Server.webp",
      alt: "server.png",
    ...
    {
      icon: "Images/javapage/Company.webp",
      alt: "company.png",
    ...
    {
      icon: "Images/javapage/molecule.webp",
      alt: "molecule.png",
    ...
    {
      icon: "Images/javapage/Database.webp",
      alt: "database.png",
...
export const pythonwebDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/pythonpage/uidesign.webp",
      alt: "uidesign.png",
    ...
    {
      icon: "Images/pythonpage/webcrawl.webp",
      alt: "webcrawl",
    ...
    {
      icon: "Images/pythonpage/desktopapp.webp",
      alt: "desktopapp.png",
    ...
    {
      icon: "Images/pythonpage/websitedev.webp",
      alt: "websitedev.png",
    ...
    {
      icon: "Images/pythonpage/content.webp",
      alt: "content.png",
    ...
    {
      icon: "Images/pythonpage/filterdata.webp",
      alt: "filterdata.png",
    ...
    {
      icon: "Images/pythonpage/Responsive.webp",
      alt: "responsive.png",
...
export const rubywebDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/rubypage/websiteDev.webp",
      alt: "websiteDev.png",
      serviceTitle: "Web-based Applications",
      serviceDesc:
    ...
    {
      icon: "Images/rubypage/Ecommerce.webp",
      alt: "Ecommerce",
    ...
    {
      icon: "Images/rubypage/automation.webp",
      alt: "automation.png",
    ...
    {
      icon: "Images/rubypage/scrapping.webp",
      alt: "scrapping.png",
    ...
    {
      icon: "Images/rubypage/Database.webp",
      alt: "Database.png",
    ...
    {
      icon: "Images/rubypage/dataprocess.webp",
      alt: "dataprocess.png",
    ...
    {
      icon: "Images/rubypage/gamedev.webp",
      alt: "gamedev.png",
...
export const golangwebDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/golangpage/secure.webp",
      alt: "secure.png",
    ...
    {
      icon: "Images/golangpage/library.webp",
      alt: "library",
    ...
    {
      icon: "Images/golangpage/foldercustom.webp",
    ...
    {
      icon: "Images/golangpage/dashboard.webp",
      alt: "dashboard.png",
    ...
    {
      icon: "Images/golangpage/crossplatform.webp",
    ...
    {
      icon: "Images/golangpage/api.webp",
      alt: "api.png",
    ...
    {
      icon: "Images/golangpage/Database.webp",
      alt: "Database.png",
...
export const javascriptwebDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/javascriptpage/presentation.webp",
    ...
    {
      icon: "Images/javascriptpage/appdev.webp",
      alt: "appdev",
    ...
    {
      icon: "Images/javascriptpage/Server.webp",
      alt: "Server.png",
    ...
    {
      icon: "Images/javascriptpage/graphics.webp",
      alt: "graphics.png",
    ...
    {
      icon: "Images/javascriptpage/crossplatform.webp",
      alt: "crossplatform.png",
    ...
    {
      icon: "Images/javascriptpage/watch.webp",
      alt: "watch.png",
    ...
    {
      icon: "Images/javascriptpage/cloud.webp",
      alt: "cloud.png",
...
export const meanDevServices = {
  ...
  serviceCard: [
    ...
    {
      icon: "Images/meanpage/Ecommerce.webp",
      alt: "Ecommerce.png",
    ...
    {
      icon: "Images/meanpage/Company.webp",
      alt: "Company.png",
    ...
    {
      icon: "Images/meanpage/website.webp",
      alt: "website.png",
    ...
    {
      icon: "Images/meanpage/migration.webp",
      alt: "migration.png",
    ...
    {
      icon: "Images/meanpage/landingpage.webp",
      alt: "landingpage.png",
...
export const phpDevServices = {
  ...
  serviceCard: [
    {
      icon: "Images/phppage/website.webp",
      alt: "website.png",
      serviceTitle: "Web-based Applications",
      serviceDesc:
    ...
    {
      icon: "Images/phppage/Ecommerce.webp",
      alt: "Ecommerce.png",
      serviceTitle: "E-commerce Applications",
      serviceDesc:
    ...
    {
      icon: "Images/phppage/graphics.webp",
      alt: "graphics.png",
    ...
    {
      icon: "Images/phppage/library.webp",
      alt: "library.png",
    ...
    {
      icon: "Images/phppage/process.webp",
      alt: "process.png",
    ...
    {
      icon: "Images/phppage/representation.webp",
