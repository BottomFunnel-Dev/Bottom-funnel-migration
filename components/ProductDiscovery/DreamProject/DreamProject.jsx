  ...
  return (
    <div className={styles.DreamProjectmaindiv}>
        <div className={styles.DreamProjectcontain} >
            ...
            <p>We have worked with some of the best innovation ideas and brands in the world across industries.</p>

        </div>
        <div>
            <button className={styles.DreamProjectbutton}>Initiate a Partnership</button>
        </div>
    </div>
  )
}
