...
export const EyeWearDevelopmentSolution = () => {
  const EyeWeardeliverydata = [
    {
      icon: "/Images/EyewearDeliveryapp/bannersBackgrounds/5860108 3.webp",
    ...
    {
      icon: "/Images/EyewearDeliveryapp/bannersBackgrounds/Wavy_Tech-31_Single-01 2.webp",
    ...
    {
      icon: "/Images/EyewearDeliveryapp/bannersBackgrounds/8454 3.webp",
    ...
    {
      icon: "/Images/EyewearDeliveryapp/bannersBackgrounds/8454 4.webp",
      htxt: "Manage Orders",
    ...
    {
      icon: "/Images/EyewearDeliveryapp/bannersBackgrounds/6240060 2.webp",
      htxt: "Better ROI",
    ...
    {
      icon: "/Images/EyewearDeliveryapp/bannersBackgrounds/7630 2.webp",
