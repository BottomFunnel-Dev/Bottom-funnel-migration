...
export const OnlinePaymentExclusive = () => {
    ...
    const onlinepaymentexclusivedata = [
        {
            icon: "/Images/onlinepaymentpage/ha/icons/bill 1.webp",
        ...
        {
            icon: "/Images/onlinepaymentpage/ha/icons/secure-shield 1.webp",
        ...
        {
            icon: "/Images/onlinepaymentpage/ha/icons/operation 1.webp",
        ...
        {
            icon: "/Images/onlinepaymentpage/ha/icons/payment-method 1.webp",
        ...
        {
            icon: "/Images/onlinepaymentpage/ha/icons/bank 1.webp",
            htxt: "ACH & Check 21",
        ...
        {
            icon: "/Images/onlinepaymentpage/ha/icons/security 1.webp",
