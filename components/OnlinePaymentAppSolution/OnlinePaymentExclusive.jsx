...
export const OnlinePaymentExclusive = () => {
  ...
  return (
    ...
    <h1><span className={styles.specialcolor}>Exclusive</span> Solutions</h1>
    <div className={styles.onlinepaymentexclusivemappingbox}>{onlinepaymentexclusivedata.map((e)=>{
        return (
