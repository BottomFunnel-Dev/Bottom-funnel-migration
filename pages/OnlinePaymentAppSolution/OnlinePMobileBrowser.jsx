...
export const OnlinePMobileBrowser = () => {
  ...
  return (
    ...
    <h1><span className={styles.specialcolor}>Mobile Browser</span> Based Payment</h1>
    </div>
    <div className={styles.onlinepmobilebrowserrightboxmappingtxt}>{onlinepmobilebrowserdata.map((e)=>{
        return (
...
<div className={styles.onlinepmobilebrowseraftermappingxtt}><h4>{e.xtt}</h4></div>
            </div>
        )
    })}</div>
    </div>
