...
export const CarServiceSolution = () => {
    ...
    return (
        <div className={styles.carservicesolutionmainboxes}>
            <div className={styles.carservicesolutioninnerboxbackground}>
                <div className={styles.carservicesolutioninnerbanckgroundplainfortext}>
                    <h1>Our Services</h1>
                    <h2>Great Car Services Solutions That We Offer</h2>
                </div>
                <div className={styles.datamaingdivcarservicesolutionforimagedivandtxt}>
                    {carsolutiondata.map((e) => {
                        return (
                            <div className={styles.datamappingafterboxindivisualcarservice}>
                                <div className={styles.datamappingcarservicesolutionforimage}>
                                    <img src={e.img} alt="carservicesolution" />
                                </div>
                                <div className={styles.datamappingservicesolutionfortext}>
                                    <h4>{e.htxt}</h4>
                                    <p>{e.stxt}</p>
                                </div>
                            </div>
