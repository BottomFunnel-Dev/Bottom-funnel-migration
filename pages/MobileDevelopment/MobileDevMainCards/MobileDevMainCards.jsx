...
// import style from "./MobileDevMainCards.module.css";

// export const MobileDevMainCards = () => {
//   return (
//     <>
//       <div className={style.mobileDevMainCardsouterDiv}>
//         <div className={style.mobileDevMainCardsContainer}>
//           <div className={style.mobileDevMainCardsBox1}>
//             <div className={style.mobileDevMainCardsContent}>
//               <img
//                 className={style.mobileDevMainCardsContentImage}
//                 src="Images/MobileDevMain/Component65.png"
//                 alt="image" />
//               <h4 className={style.mobileDevMainCardsContentHeading}>
//                 Andriod App Development
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               Bottom funnel android app development service can help you to design, 
//               develop and deploy the best Android the best Android app for your business.
//                Our team of experienced and qualified developers will work with you.
//               </div>
//             </div>
...
//                 alt="image" />
//               <h4 className={style.mobileDevMainCardsContentHeading1}>
//                 IOS App Development
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               Over a decade in custom iOS app development, 
//               we have built dozens of applications for different Apple devices. 
//               Some of them won prestigious design awards, other
//                became new profit centers.
//               </div>
//             </div>
...
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               Kotlin is language that helps you create applications 
//               in a more efficient way. It is concise, safe and interoperable with Java.
//                Kotlin is an open source project under the Apache 2.0 license.
//               </div>
//             </div>
//           </div>
...
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               Bottom funnel flutter app development is all about the
//                ease of use and an intuitive user experience.
//                 Flutter is a great option for both beginners and experts alike.
//                  It easier to build apps that have a wide range.

//               </div>
//             </div>

//             <div className={style.mobileDevMainCardsContent1}>
//               <img
//                 className={style.mobileDevMainCardsContentImage}
...
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//              If you’re looking for an app development partner that 
//              can create high-quality, mobile apps from scratch, 
//              then look no further than our team of React Native experts.
//               fugiat neque ab, id quidem. Sed!
//               </div>
//             </div>

//             <div className={style.mobileDevMainCardsContent2}>
//               <img
//                 className={style.mobileDevMainCardsContentImage}
...
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               Xamarin app development is an exciting way to create 
//               cross-platform mobile apps. Using the Xamarin platform,
//                you can write your code once and deploy it to multiple platforms, 
...
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               We have extensive expertise in the Ionic framework that
//                allows us to develop feature-rich and robust cross-platform Apps.
//                 Our Ionic Development team produces the needed widgets in HTML5.
//               </div>
//             </div>
...
//               </h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               The use of wearable technology for both individuals and 
//               business are growing at a rapid rate. Whether it is for
//                tracking steps walked or sending real-time work push notifications,
//                 wearable tech of Android iOS.
//               </div>
//             </div>
...
//                 alt="image" />
//               <h4 className={style.mobileDevMainCardsContentHeading}>MObile UI UX</h4>
//               <div className={style.mobileDevMainCardsContentText}>
//               Mobile UI UX refers to the user interface and user experience 
//               of a mobile application. It is Important to create a good mobile
//                UI UX in order to provide users with a positive experience when 
//                using the app.
//               </div>
//             </div>
//           </div>
